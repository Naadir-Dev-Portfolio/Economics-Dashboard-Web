...
SECTIONS = {
    ...
    "housing": {
        ...
        "series": [
            {"id": "uk_hpi",       "name": "UK House Price Index", "region": "UK", "unit": "index", "fred": "QGBN628BIS",  "freq": "q", "note": "BIS, 2010=100."},
    ...
    "employment": {
        "title": "Employment",
        "icon": "groups",
        "blurb": "Jobs, unemployment, participation — the human ledger.",
        "series": [
            {"id": "us_unrate",  "name": "US Unemployment",    "region": "US", "unit": "%", "fred": "UNRATE"},
            {"id": "uk_unrate",  "name": "UK Unemployment",    "region": "UK", "unit": "%", "fred": "LRHUTTTTGBM156S"},
