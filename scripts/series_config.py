...
SECTIONS = {
    ...
    "rates": {
        ...
        "series": [
            ...
            {"id": "boe_rate",   "name": "UK BoE Bank Rate", "region": "UK", "unit": "%", "bis_policy": "GB", "history_version": 2, "note": "BIS daily policy-rate observations, sourced from the Bank of England. Observation date and refresh time are separate."},
            {"id": "ecb_rate",   "name": "ECB Deposit Rate",     "region": "EU", "unit": "%", "fred": "ECBDFR",          "note": "Eurozone benchmark."},
            {"id": "boj_rate",   "name": "Japan Policy Rate",    "region": "JP", "unit": "%", "bis_policy": "JP", "note": "BIS daily central bank policy rate, sourced from the Bank of Japan."},
            {"id": "boc_rate",   "name": "Canada Overnight Target", "region": "CA", "unit": "%", "bis_policy": "CA"},
            {"id": "snb_rate",   "name": "Swiss 3-Month Rate",   "region": "CH", "unit": "%", "fred": "IR3TIB01CHM156N"},
            {"id": "rba_rate",   "name": "Australia Cash Rate Target", "region": "AU", "unit": "%", "bis_policy": "AU"},
